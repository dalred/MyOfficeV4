...
from MyOfficeV6_1_TestRename import main_
...
mydir7 = path_dirname_ + "\\" + u"Файл с размещением системы рейтингования _02.09.2020 — копия.xlsx"
...
mydir15_out = path_dirname_ + "\\" + "По итогам 1 этапа - не прошел.docx"
mydir16_out = path_dirname_ + "\\" + "По итогам 1 этапа - прошел.docx"
mydir17 = mydir + "\\" + u"Результаты первого этапа"
mydir18 = path_dirname_ + "\\" + u"3.2. информац. сообщение - резерв.docx"
mydirs_ = [mydir0, mydir1, mydir2, mydir3, mydir4, mydir5, mydir6, mydir7,mydir8,mydir9,mydir10, mydir11,mydir12_out,mydir13_out,mydir14_out,mydir15_out,mydir16_out,mydir17,mydir18]
    ...
    if combobox1.SelectedIndex == 0:
        ...
        if not (os.path.exists(mydirs_[17])):
            try:
                ...
                MessageBox.Show(u"Создана папка: " + os.path.basename(mydirs_[17]), u"Информация", MessageBoxButtons.OK,
                                MessageBoxIcon.Information)
            except Exception:
