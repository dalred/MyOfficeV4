...
def extract_txt_doc(path, folderName, mydirs_, lena):
    ...
    parent_email = table_input.getCell('C41').getRawValue()
    parent_phone = table_input.getCell('C43').getRawValue()
...
def write_table(all_str_lst, worker, datetime1_end, n_rows):
    ...
    for str_ in all_str_lst:
        ...
        if regex_date.match(str_[3]):
            ...
            table_output_xlsx.getCell("G" + row_str).setText("Error date")
            pass
